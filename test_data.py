...
from constants.constants import VERSION, FILE_VERSION, PROJECTED_LINEUP_VERSION, PROJECTED_LINEUP_FILE_VERSION, XGB_VERSION, XGB_FILE_VERSION
...
if __name__ == '__main__':
  ...
  #   dump(result,f'test_data/test_data_v{XGB_FILE_VERSION}_xgboost.joblib')
  # else:
  if PROJECTED_LINEUP:
