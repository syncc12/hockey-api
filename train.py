...
SKIP_SEASONS = [
  ...
  '19771978','19801981','19811982','19821983','19871988','19881989',
  '19891990','19941995',
]
...
if __name__ == '__main__':
  if RE_PULL:
    ...
    pool.close()
    dump(result,'training_data/training_data_v3.joblib')
    # f = open('training_data/training_data_text.txt', 'w')
    # f.write(json.dumps(result[60000:60500]))
  else:
    result = load('training_data/training_data_v3.joblib')
    f = open('training_data/training_data_text.txt', 'w')
    f.write(json.dumps(result[60000:60500]))
