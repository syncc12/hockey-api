...
def nhl_data(game={},boxscore={},test=False,message=''):
  ...
  ref1 = n2n(safe_chain(boxscore,'boxscore','gameInfo','referees',0,'default'))
  ref2 = n2n(safe_chain(boxscore,'boxscore','gameInfo','referees',1,'default'))
  linesman1 = n2n(safe_chain(boxscore,'boxscore','gameInfo','linesmen',0,'default'))
  linesman1 = n2n(safe_chain(boxscore,'boxscore','gameInfo','linesmen',1,'default'))
  ...
  if test:
    ...
    if safe_chain(boxscore,'periodDescriptor','periodType') != 'REG':
      period = safe_chain(boxscore,'periodDescriptor','periodType')
...
def nhl_ai(game_data):
  ...
  return nhl_data(game=game,boxscore=boxscore,test=False,message=message)
