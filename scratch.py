...
# import warnings
# from util.team_models import PREDICT, TEST_H2H, W_MODELS, L_MODELS
...
# prediction,confidences,away_prediction,home_prediction,away_probability,home_probability,w_prediction_away,l_prediction_away,w_prediction_home,l_prediction_home,w_probability_away,l_probability_away,w_probability_home,l_probability_home = TEST_H2H(TEST_DATA, W_MODELS, L_MODELS)
