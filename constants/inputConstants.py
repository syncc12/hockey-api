...
Y_V4_OUTPUTS = ['homeScore','awayScore','winner']

X_V5_INPUTS = X_V4_INPUTS
Y_V5_OUTPUTS = Y_V4_OUTPUTS
...
BASE_INPUTS = [
  ...
  # 'matchupHomeHits',
  # 'matchupHomePIM',
  # 'matchupHomePowerplays',
  # 'matchupHomePowerplayGoals',
  # 'matchupHomeFaceoffWinPercent',
  # 'matchupHomeBlocks',
  # 'matchupHomeWinLoss',
  # 'matchupAwayScores',
  # 'matchupAwayShots',
  # 'matchupAwayHits',
  # 'matchupAwayPIM',
  # 'matchupAwayPowerplays',
  # 'matchupAwayPowerplayGoals',
  # 'matchupAwayFaceoffWinPercent',
  # 'matchupAwayBlocks',
  # 'matchupAwayWinLoss',
  # 'last5HomeScores',
  # 'last5HomeShots',
  ...
  # 'last5HomePIM',
  # 'last5HomePowerplays',
  # 'last5HomePowerplayGoals',
  # 'last5HomeFaceoffWinPercent',
  # 'last5HomeBlocks',
  # 'last5HomeWinLoss',
  # 'last5HomeStartUTCTimes',
  # 'last5HomeEasternOffsets',
  # 'last5HomeVenueOffsets',
  # 'last5AwayScores',
  # 'last5AwayShots',
  # 'last5AwayHits',
  # 'last5AwayPIM',
  # 'last5AwayPowerplays',
  # 'last5AwayPowerplayGoals',
  # 'last5AwayFaceoffWinPercent',
  # 'last5AwayBlocks',
  # 'last5AwayWinLoss',
  # 'last5AwayStartUTCTimes',
  # 'last5AwayEasternOffsets',
  # 'last5AwayVenueOffsets',
  # 'last10HomeScores',
  # 'last10HomeShots',
  # 'last10HomeHits',
  # 'last10HomePIM',
  # 'last10HomePowerplays',
  # 'last10HomePowerplayGoals',
  # 'last10HomeFaceoffWinPercent',
  # 'last10HomeBlocks',
  # 'last10HomeWinLoss',
  # 'last10HomeStartUTCTimes',
  # 'last10HomeEasternOffsets',
  # 'last10HomeVenueOffsets',
  # 'last10AwayScores',
  # 'last10AwayShots',
  # 'last10AwayHits',
  # 'last10AwayPIM',
  # 'last10AwayPowerplays',
  # 'last10AwayPowerplayGoals',
  # 'last10AwayFaceoffWinPercent',
  # 'last10AwayBlocks',
  # 'last10AwayWinLoss',
  # 'last10AwayStartUTCTimes',
  # 'last10AwayEasternOffsets',
  # 'last10AwayVenueOffsets',
  # 'seasonHomeScores',
  # 'seasonHomeShots',
  # 'seasonHomeHits',
  # 'seasonHomePIM',
  # 'seasonHomePowerplays',
  # 'seasonHomePowerplayGoals',
  # 'seasonHomeFaceoffWinPercent',
  # 'seasonHomeBlocks',
  # 'seasonHomeWinLoss',
  # 'seasonHomeStartUTCTimes',
  # 'seasonHomeEasternOffsets',
  # 'seasonHomeVenueOffsets',
  # 'seasonAwayScores',
  # 'seasonAwayShots',
  # 'seasonAwayHits',
  # 'seasonAwayPIM',
  # 'seasonAwayPowerplays',
  # 'seasonAwayPowerplayGoals',
  # 'seasonAwayFaceoffWinPercent',
  # 'seasonAwayBlocks',
  # 'seasonAwayWinLoss',
  # 'seasonAwayStartUTCTimes',
  # 'seasonAwayEasternOffsets',
  # 'seasonAwayVenueOffsets',
  # 'homeRest',
  # 'awayRest',
  # 'homeLastRest',
  # 'awayLastRest',
