...
def projected_shift(test_data):
  ...
  for i, data in enumerate(test_data):
    ...
    if last_homeTeam_game is None or last_awayTeam_game is None:
      ...
      current_test_data.append(current_data)
      for ii in shift_keys:
        copy_data[f'away{ii}'] = last_awayTeam_game[f'{away_home_away}{ii}']
        copy_data[f'home{ii}'] = last_homeTeam_game[f'{home_home_away}{ii}']
      projected_test_data.append(copy_data)
  return projected_test_data, current_test_data
